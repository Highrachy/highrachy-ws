<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_expertise"; $sub_title2="expertise-slogan"; ?>
<?php 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if (empty($errors)){
		...
		if ($value == 1) { // If it ran OK.
					redirect('expertise_content.php?s='.$id.'&action=slogan');		
		} else { 
	...
	$query = "SELECT id, name, content,modified from expertise where id='$id'";
