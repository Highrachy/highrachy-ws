<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_solutions"; $sub_title2="solutions_content"; $sub_title3="remove-solutions-picture"; ?>
<?php
...
if (isset($_GET['s'])){
	...
	if ($id == ""){
		redirect("dashboard_solutions.php");
	}  else {
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST'){
			if (isset($_POST['Delete'])){
				$id = $_POST['Delete'];
				$query = "SELECT pics FROM solutions WHERE id = '$id'";
				...
				if ($total_rows == 1) { // No problems! You can delete, file exist;
					...
					$picture = $rows['pics'];
					$data['pics'] = "NULL";
					$result = $db->update_query("solutions",$data,"id=$id");
					if ($result == 1) { // If it ran OK.
						
						unlink('img/solutions/'.$picture);
						redirect('solutions_content.php?pics=remove&s='.$id);
						exit();
					}
				}
			}
                    ...
                    <div id="tab-one">
                      ...
                      <div class="list-wrap">
                          ...
                          <form method="post">
                                ...
                                <img src="img/solutions/<?php echo $pics ?>"><br><br>
                                  <?php alert() ?> 
                                  <div class="align-right">
                                    <input type="submit" class="btn" value="Yes">
                              		<a href="solutions_content.php?s=<?php echo $id ?>" class="btn">No</a>
                                  </div>
