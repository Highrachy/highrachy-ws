...
foreach ($rows as $row){
	...
	$tbody .= ">$count</td><td>".$row['name']."</td><td>{$row['description']}</td><td>{$row['show_home']}</td><td><a href='view-slideshow.php?s={$row['slideshow_id']}'>View</a></td><td><a href='edit-slideshow.php?s={$row['slideshow_id']}'>Edit</a></td></tr>";
}
?>
                      ...
                      <div class="list-wrap">
                          ...
                          <ul class="thumbnails">
                            ...
                            <table>
                            	<tbody>
                                <tr>
                                  <th class="first-row" style="width :5%">S/N</th>
                                  <th class="first-row" style="width :15%">Image</th>
                                  <th class="first-row" style="width :50%">Description</th>
