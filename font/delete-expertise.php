<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_expertise"; $sub_title2="delete-expertise"; ?>
<?php
...
$showInfo = false;
//Check if the expertise id is set
if (isset($_GET['s'])){
	$showInfo = true;
	$id = $_GET['s'];
	
	//If the expertise id is set but it is not defined
	if ($id == ""){
		...
		$query = "SELECT name FROM expertise WHERE expertise.id = '$id'";
...
if (!$showInfo) {
	...
	$option = "<option>- Select Expertise Page-</option>";
                                ...
                                <input type="hidden" name="Delete" value="<?php echo $id ?>">
                                  ...
                                  <div class="align-right">
                                    <input type="submit" class="btn" value="Yes">
                              		<a href="dashboard_expertise.php" class="btn">No</a>
                                  </div>
                              <div class="clearfix"></div>
                            </fieldset>
                        </form>
                        <?php } else { ?>
                        <h2>Delete An Expertise Page</h2>                      	
