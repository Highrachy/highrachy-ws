<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_expertise";?>
<?php
...
$query = "SELECT expertise.id
				, expertise.name as e_name
				, icons.name as i_name
				FROM expertise
					INNER JOIN icons
						ON icons.id = expertise.icons_id
							WHERE link =0";
...
foreach ($rows as $row){
	$content .= '<li class="span2"><div class="thumbnail"><div class="content">
                 <a href="expertise_content.php?s='.$row['id'].'"><i class="'.$row['i_name'].'"></i>'.$row['e_name'].'</a>
                 </div></div></li>';
}
                      ...
                      <div class="list-wrap">
                          ...
                          <?php echo $content ?>
                              ...
                              <li class="span2">
                                <div class="thumbnail">
                                	<div class="content">
                                  		<a href="add-expertise.php"><i class="icon-plus-sign"></i>Add New Page</a>
                                  	</div>
                                </div>
                              </li>
                             ...
                             <li class="span2">
                                <div class="thumbnail">
                                	<div class="content">
                                  		<a href="delete-expertise.php"><i class="icon-remove-sign"></i>Delete Page</a>
                                  	</div>
                                </div>
                              </li>
                            </ul>
