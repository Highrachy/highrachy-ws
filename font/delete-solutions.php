<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_solutions"; $sub_title2="delete-solutions"; ?>
<?php
                                ...
                                <input type="hidden" name="Delete" value="<?php echo $id ?>">
                                  ...
                                  <div class="align-right">
                                    <input type="submit" class="btn" value="Yes">
                              		<a href="dashboard_solutions.php" class="btn">No</a>
                                  </div>
                              <div class="clearfix"></div>
                            </fieldset>
                        </form>
                        <?php } else { ?>
                        <h2>Delete An solutions Page</h2>                      	
