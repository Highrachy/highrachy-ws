...
foreach ($rows as $row){
	$count++;
	$content .= '<div><h3>'.$row['name'].'</h3><p>'.$row['content'].'<small class="edit"><a href="edit-about-content.php?s='.$row['id'].'"><i class="icon-edit"></i> Edit</a> &nbsp;&nbsp; <a href="delete-about-content.php?s='.$row['id'].'"><i class="icon-remove-sign"></i> Delete</a></small></p></div>';	
