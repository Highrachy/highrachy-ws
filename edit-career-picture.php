<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_career"; $sub_title2="career_content"; $sub_title3="edit-career-picture"; ?>
<?php 
...
{
	include('includes/edit-career-picture.inc.php');
} 
                    ...
                    <div id="tab-one">
                      ...
                      <div class="list-wrap">
                          <form method="post" id="custom" enctype="multipart/form-data"> 
                                    ...
                                    <div>
									<input type="submit" class="btn" value="Add Picture">&nbsp;&nbsp;<a href="career_content.php?s=<?php echo $id ?>" class="btn"> Back </a>
                                    </div>
                                    <?php } else { ?>
                          			 	<h2>Change <?php echo $name ?>'s Picture</h2>
                          				<img src="img/career/<?php echo $old_pics ?>" alt="The Current Picture used on the page">
                                        <label for="pics">Change Picture</label><input type="file" name="pics">
                                        <div class="clearfix"></div>
                                        <div>
                                        <input type="hidden" name="old_pics" value="<?php echo $old_pics ?>">
                                        <input type="submit" class="btn" value="Change Picture">&nbsp;&nbsp;<a href="career_content.php?s=<?php echo $id ?>" class="btn"> Back </a>
                                        </div>
                                    <?php } ?>
