<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_career"; $sub_title2="career-slogan"; ?>
<?php 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if (empty($errors)){
		...
		if ($value >= 1) { // If it ran OK.
					redirect('career_content.php?s='.$id.'&action=slogan');		
		} else { 
	...
	$query = "SELECT id, name, content,modified from career where id='$id'";
