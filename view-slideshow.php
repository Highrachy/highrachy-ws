<?php $dashboard = true; $title = "dashboard_slideshow"; $sub_title = "edit_slideshow"; $readonly = true; ?>
<?php 
                    ...
                    <div id="tab-one">
                      ...
                      <div class="list-wrap">
                      	...
                      	<?php if ($showInfo) { ?>
                                                    ...
                                                    <label>Description</label><textarea name="description" id="description" class="text-input" rows="10" cols="80" disabled><?php echo strip_tags($description) ?></textarea>           
                                     <div class="align-right pad30">
									<a href="edit-slideshow.php?s=<?php echo $slideshow_id ?>"  class="btn">Edit Slideshow</a>&nbsp;&nbsp;
                                    <a href="delete-slideshow.php?s=<?php echo $slideshow_id ?>"  class="btn">Delete Slideshow</a>
                                    </div>
