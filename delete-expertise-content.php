<?php $dashboard = true; $title = "dashboard_content"; $sub_title= "dashboard_expertise"; $sub_title2="expertise-content";$sub_title3="delete-expertise-content"; ?>
<?php
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST'){
			if (isset($_POST['Delete'])){
				...
				if ($total_rows == 1) { // No problems! You can delete, file exist;
					//To Delete
					$query = "DELETE FROM expertise WHERE id = '$id' LIMIT 1";
					$result = $db->delete_row($query);
					if ($result == 1) { // If it ran OK.
						redirect('expertise_content.php?s='.$link_id.'&action=delete');
						exit();
					}
				}
			}
                                ...
                                <input type="hidden" name="Delete" value="<?php echo $id ?>">
                                  ...
                                  <div class="align-right">
                                    <input type="submit" class="btn" value="Yes">
                              		<a href="expertise_content.php" class="btn">No</a>
                                  </div>
