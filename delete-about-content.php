<?php $dashboard = true; $title = "dashboard_content"; $sub_title1="about-content";$sub_title2="delete-about-content"; ?>
<?php
...
if (isset($_GET['s'])){
	...
	if ($id == ""){
			...
			if (isset($_POST['Delete'])){
				...
				if ($total_rows == 1) { // No problems! You can delete, file exist;
					...
					if ($result == 1) { // If it ran OK.
						redirect('about_content.php?action=delete');
						exit();
					}
				}
			}
		...
		$query = "SELECT name FROM about WHERE about.id = '$id'";
                                ...
                                <input type="hidden" name="Delete" value="<?php echo $id ?>">
                                  ...
                                  <div class="align-right">
                                    <input type="submit" class="btn" value="Yes">
                              		<a href="about_content.php" class="btn">No</a>
                                  </div>
