...
function upload_crop_image($image_name,$destination,$resizeby,$resizeto){
	define('DESTINATION', $destination);
	define('RESIZEBY', $resizeby);
	define('RESIZETO', $resizeto);
	define('QUALITY', 100);
	
	$image = new Image($_FILES[$image_name]['tmp_name']);
	
	$image->destination = DESTINATION.$_FILES[$image_name]['name'];
