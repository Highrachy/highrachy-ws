...
else if ($action == 'product') $success = "Your Product Page has been successfully updated";
                          ...
                          <ul class="thumbnails">
                             ...
                             <li class="span2">
                              ...
                              <li class="span2">
                                <div class="thumbnail">
                                	<div class="content">
                                    	<a href="edit-slogan.php?id=5"><i class="icon-shopping-cart"></i>Products</a>
                                  	</div>
                                </div>
                              </li>
                              ...
                              <li class="span2">
                                <div class="thumbnail">
                                	<div class="content">
                                    	<a href="dashboard_career.php"><i class="icon-briefcase"></i>Career</a>
                                  	</div>
                                </div>
                              </li>
